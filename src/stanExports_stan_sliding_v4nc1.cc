...
#include "stanExports_stan_sliding_v4nc1.h"

RCPP_MODULE(stan_fit4stan_sliding_v4nc1_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_stan_sliding_v4nc1")
